...
const NewCars = () => {
    return (
        <div className="p-5" style={{ background: '#f8f8f8' }}>
            <h2>Control Your Amazing Experience</h2>
            ...
            <div className="row d-flex align-items-center">
                ...
                <div className="col-lg-5 mx-auto text-start">
                    ...
                    <p>Get  personalized car deals, including manufacturer incentives and discounts. Next, build a custom deal that includes the value of your trade.</p>
